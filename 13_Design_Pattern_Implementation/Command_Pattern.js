...
waiter.takeOrder(new OrderFoodCommand(chef, "Nasi Lemak"));
waiter.takeOrder(new OrderFoodCommand(chef, "Magelangan"));
waiter.takeOrder(new CancelOrderCommand(chef, "Nasi Goreng"));
waiter.takeOrder(new OrderFoodCommand(chef, "Es Jeruk"));
